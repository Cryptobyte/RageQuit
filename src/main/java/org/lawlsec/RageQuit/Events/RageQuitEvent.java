...
/*
  ...
  easier.
 */
public class RageQuitEvent extends Event implements Cancellable {
    ...
    */
    ...
    /*
      ...
      message that the player is sent
      when they are kicked after running
      the /ragequit command.
    */
    ...
    */
    ...
    /*
      Initializer for the event. This
      makes it so that when a class
      creates a new object of this event
      the calling class must provide basic
      data. This also sets up our
      timestamp for use in listeners.
     */
    public RageQuitEvent(Player player, String message) {
